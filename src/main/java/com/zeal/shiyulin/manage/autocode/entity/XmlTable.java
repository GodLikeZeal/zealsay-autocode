...
import com.zeal.shiyulin.manage.Utils.DateJsonDeserializer;
...
import com.zeal.shiyulin.manage.Utils.DateJsonSerializer;
 ...
 * @version 2013-10-15
 */
public class XmlTable extends DataEntity<XmlTable> {
	...
	private List<XmlTableColumn> columnList = Lists.newArrayList();	// 表列

	private String nameLike; 	// 按名称模糊查询
	
	private List<String> pkList; // 当前表主键列表
	
	private XmlTable parent;	// 父表对象
	private List<XmlTable> childList = Lists.newArrayList();	// 子表列表
	...
	public void setParent(XmlTable parent) {
		this.parent = parent;
	}

	public List<XmlTableColumn> getColumnList() {
		return columnList;
	}

	public void setColumnList(List<XmlTableColumn> columnList) {
		this.columnList = columnList;
	}

	public List<XmlTable> getChildList() {
		return childList;
	}

	public void setChildList(List<XmlTable> childList) {
	...
	public List<String> getImportList(){
		...
		for (XmlTableColumn column : getColumnList()){
	...
	public Boolean getCreateDateExists(){
		for (XmlTableColumn c : columnList){
