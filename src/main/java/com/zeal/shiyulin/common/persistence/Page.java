...
import com.zeal.shiyulin.common.config.Global;
import com.zeal.shiyulin.common.utils.CookieUtils;
...
public class Page<T> {
	...
	public String toString() {
		...
		if (pageNo == first) {// 如果是首页    pengb update 20150327
		...
		if (pageNo == last) {   // 如果是尾页   pengb update 20150327
...
//		sb.append("<li class=\"disabled controls\">当前<a href=\"javascript:\"> ");
//		sb.append("<input type=\"text\" value=\""+pageNo+"\" onkeypress=\"var e=window.event||this;var c=e.keyCode||e.which;if(c==13)");
//		sb.append(funcName+"(this.value,"+pageSize+",'"+funcParam+"');\" onclick=\"this.select();\"/> / ");
//		sb.append("</a><input type=\"text\" value=\""+pageSize+"\" onkeypress=\"var e=window.event||this;var c=e.keyCode||e.which;if(c==13)");
//		sb.append(funcName+"("+pageNo+",this.value,'"+funcParam+"');\" onclick=\"this.select();\"/> 条，");
//		sb.append("</a>共 " + count + " 条"+(message!=null?message:"")+"</li>\n");
		
		
		//  总页数    pengb update 20150327
		long totalPage = count % pageSize == 0 ? count/pageSize : count/pageSize + 1;
		sb.append("<li class=\"disabled controls\">当前 "+pageNo);
		sb.append(" / " + totalPage + "页,");
		sb.append("</a>共 " + count + " 条"+(message!=null?message:"")+"</li>\n");
